<section class="header-row">
    <div class="row d-flex">
        <div class="section-title aos-init aos-animate" data-aos="fade-up">
            <h2>Clinic Management System (ANGLE)
            </h2>
            <p>
                <a href="<?php echo base_url(); ?>">Home</a> / Clinic Management System (ANGLE)
            </p>
        </div>
    </div>
</section>
<section>
    <div class="container">
        <div style="display: flex; align-items:center" class="row">
            <div class="col-sm-6">
                <img class="img-fluid" src="<?php echo base_url('assets/img/illus/gallery-2.jpeg'); ?>" alt="">
            </div>
            <div class="col-sm-6">
                <p>
                    PROSOFT is a certified provider of global Healthcare services.
                    PROSOFT was founded in 2007 with and idea of easing the stress on
                    healthcare services with the goal of providing easy and best solutions forever.
                    <br /><br />
                    Our Innovative Healthcare solutions are usedby service providers such asHospitals,
                    Diagnostic centers,And Specialty clinics solutions.
                </p>
            </div>
        </div>
    </div>
</section>
<section style="background-color: #f1f4f6;" id="services" class="services">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 d-flex align-items-stretch mb-5 mb-lg-0">
                <div class="icon-box aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <h4 class="title">Operator/Call Center</h4>
                    <p class="description">
                        <ul>
            ...
            <div class="col-md-4 d-flex align-items-stretch mb-5 mb-lg-0">
                <div class="icon-box aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                    <div class="icon"><i class="fa fa-gamepad "></i></div>
                    <h4 class="title">Treatment Room/Nurse Desk</h4>
                    <p class="description">
                        <ul>
                            <li>
        ...
        <div class="row">
            ...
            <div class="col-md-9 d-flex align-items-stretch mb-5 mb-lg-0">
                <div class="icon-box aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                    <div class="icon"><i class="fa fa-gamepad "></i></div>
            ...
            <div class="col-md-3 d-flex align-items-stretch mb-5 mb-lg-0">
                <div class="icon-box aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                    <div class="icon"><i class="fa fa-gamepad "></i></div>
                    <h4 class="title">Resubmission</h4>
                    <p class="description">
                        <ul>
                            <li>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 d-flex align-items-stretch">
                <div class="card aos-init aos-animate" style="background-image: url(&quot;assets/img/more-services-1.jpg&quot;);" data-aos="fade-up" data-aos-delay="100">
                    <div class="card-body">
                        <h5 class="card-title">Purchase</h5>
                        <p class="card-text">

                            Creating LPO and printing the LPO with options like LPO authentication from Accounts/Supervisor </p>
                        <hr>
                        <p class="card-text">
            ...
            <div class="col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
                <div class="card aos-init aos-animate" style="background-image: url(&quot;assets/img/more-services-2.jpg&quot;);" data-aos="fade-up" data-aos-delay="200">
                    <div class="card-body">
                        <h5 class="card-title"><a href="">Sales
                            </a></h5>
                        <p class="card-text">
                            Patients from the medical center are directly shown in pharmacy with prescription and diagnosis codes
                            Approval request can be sent from system all insurance companies
                        </p>
                        <hr>
                        <p class="card-text">
                        ...
                        <p class="card-text">
                            ...
                            Audit logs to track all the user activities</p>
                        <hr>
                        <p class="card-text">
                            Daily reports to track the sales, itemwise report, and many other reports.</p>
                    </div>
                </div>

            </div>
            <div class="col-md-6 d-flex align-items-stretch mt-4">
                <div class="card aos-init aos-animate" style="background-image: url(&quot;assets/img/more-services-3.jpg&quot;);" data-aos="fade-up" data-aos-delay="100">
                    <div class="card-body">
                        <h5 class="card-title"><a href="">Reconciliation</a></h5>
                        ...
                        <hr>
                        <p class="card-text">
                            After reconciliation, different reports are available for the management to track the payments. Reports like Shortage report with Fully rejected, Fully paid, Partially Paid claims, Ageing report to track the outstanding payment with different time periods, Denial analysis reports, etc.</p>
                        <p></p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 d-flex align-items-stretch mt-4">
                <div class="card aos-init aos-animate" style="background-image: url(&quot;assets/img/more-services-4.jpg&quot;);" data-aos="fade-up" data-aos-delay="200">
                    <div class="card-body">
                        <h5 class="card-title"><a href="">Resubmission</a></h5>
                        <p class="card-text">Automatic Remittance Advice downloads from Shafafiya.</p>
                        <hr>
                        <p class="card-text">
                            Selecting files to be reconciled in system from the available downloads
                        ...
                        <hr>
                        <p class="card-text">
                            Generating the resubmission batches and automatic uploads are available</p>
                    </div>
                </div>
            </div>
        </div>
