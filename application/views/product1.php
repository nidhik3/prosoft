...
<section class="tm-section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 text-row">
                    <h3>Our strengths in the Healthcare arena</h3>
                    <p>-Exceptional talent pool across domain, technology and management which can be leveraged for any kind of Healthcare project
                        <br />-Backed by Healthcare domain expertise and leadership
                        <br />-Prevailing culture of pioneering and imbibing emerging technologies
                        <br />-Strategic alliances to deliver the maximum value to customers
                        <br />-Well proven implementation and project management skills
                        <br />-Global presence
                        <br />-Professional Strength
                        <br />-Cost effective solutions
                        <br />-High level employee retention policy
                    </p>
                </div>
                <div class="col-sm-6">
                    <img class="img-fluid" src="https://prosoft.org.in/assets/img/illus/hero-img.png" alt="">
                </div>
            </div>
            <br /> <br />
            <div class="row">
                <div class="col-sm-6">
                    <img class="img-fluid" src="https://prosoft.org.in/assets/img/illus/why-us.png" alt="">
                </div>
                <div class="col-sm-6 text-row">
                    <h3>Our Offerings for the Healthcare Industry</h3>
                    <p>-Exceptional talent pool across domain, technology and management which can be leveraged for any kind of Healthcare project
                        <br />-Backed by Healthcare domain expertise and leadership
                        <br />-Prevailing culture of pioneering and imbibing emerging technologies
                        <br />-Strategic alliances to deliver the maximum value to customers
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0">
                    <div class="icon-box aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                        <div class="icon"><i class="fa fa-gamepad "></i></div>
                        <h4 class="title">Infrastructure Management Configuration</h4>
                        <p class="description">
                            <ul>
                                <li>System Configuration – (Legal Entity, Operating Unit etc.)</li>
                                <li> User Management (Role wise / User wise - rights wise)</li>
                                <li> Master Configuration</li>
                                <li> Communication Interfaces (SMS / Email etc.)</li>
                                <li> Integration (Lab Equipment, PACS / RIS / LIS System etc.)</li>
                            </ul>
                        </p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0">
                    <div class="icon-box aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                        <div class="icon"><i class="fa fa-gamepad "></i></div>
                        <h4 class="title">Application Administration</h4>
                        <p class="description">
                            <ul>
                                <li>
                ...
                <div class="col-md-8 col-lg-8 d-flex align-items-stretch mb-5 mb-lg-0">
                    <div class="icon-box aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                        <div class="icon"><i class="fa fa-gamepad "></i></div>
                        <h4 class="title">IPD Management</h4>
                        <p class="description">
                            <ul>
                                <li>
            ...
            <br />
            <div class="row">
                <div class="col-lg-7 d-flex align-items-stretch mb-5 mb-lg-0">
                    <div class="icon-box aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                        <div class="icon"><i class="fa fa-gamepad "></i></div>
                        <h4 class="title">
                            Nursing Work Bench</h4>
                        <p class="description">
                            <ul>
                                <li>
                ...
                <div class="col-lg-5 d-flex align-items-stretch mb-5 mb-lg-0">
                    <div class="icon-box aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                        <div class="icon"><i class="fa fa-gamepad "></i></div>
                        <h4 class="title">
                            Doctor Management</h4>
                        <p class="description">
                            <ul>
                                <li>
            ...
            <br />
            <div class="row">
                <div class="col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0">
                    <div class="icon-box aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                        <div class="icon"><i class="fa fa-gamepad "></i></div>
                        <h4 class="title">
                            Service Center</h4>
                ...
                <div class="col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0">
                    <div class="icon-box aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                        <div class="icon"><i class="fa fa-gamepad "></i></div>
                        <h4 class="title">
                            HealthCare Contracts/Insurance/Schemes Management</h4>
                        <p class="description">
                            <ul>
                                <li>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                    <div class="icon-box aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                        <div class="icon"><i class="fa fa-gamepad "></i></div>
                        <h4 class="title">
                            PIS/PAYROLL Functionality</h4>
                        <p class="description">
                            <ul>
                                <li>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0">
                    <div class="icon-box aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                        <div class="icon"><i class="fa fa-gamepad "></i></div>
                        <h4 class="title">
                            Integration & Interfacing</h4>
                        <p class="description">
                            <ul>
                                <li>
                                    Pushing Patient Data through ANGLEPRO HIS to services
                                </li>
                                <li>
